...
export const UserSettingsModal = ({ isOpen, onOpenChange }: { isOpen: boolean; onOpenChange: (isOpen: boolean) => void }) => {
                ...
                <Modal>
                    <Dialog>
                        <div className="relative w-full overflow-hidden rounded-[20px] bg-primary shadow-xl sm:max-w-160">
                            <CloseButton onClick={() => onOpenChange(false)} theme="dark" size="md" className="absolute top-3 right-3 md:hidden" />
                            <CloseButton onClick={() => onOpenChange(false)} theme="dark" size="lg" className="absolute top-3 right-3 max-md:hidden" />
                            ...
                            <div className="z-10 flex flex-col pt-6 pb-4 sm:pt-8 sm:pb-6">
                                <div className="flex flex-1 flex-col-reverse gap-3 px-4 sm:grid sm:grid-cols-2 sm:px-6">
                                    <Button color="secondary" size="lg" iconLeading={Save01} onClick={() => onOpenChange(false)}>
                                        Save as draft
                                    </Button>

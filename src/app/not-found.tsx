                ...
                <div className="flex w-full max-w-3xl flex-col gap-8 md:gap-12">
                    <div className="flex flex-col gap-4 md:gap-6">
                        <div className="flex flex-col gap-3">
                            ...
                            <h1 className="text-display-md font-semibold text-primary md:text-display-lg lg:text-display-xl">Whoops! Page not found</h1>
                        </div>
                        <p className="text-lg text-tertiary md:text-xl">Looks like you are lost.</p>
                    </div>
